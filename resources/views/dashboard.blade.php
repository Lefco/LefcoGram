...
<div class="flex justify-center">
    <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
        <div class="w-8/12 lg:w-6/12 px-5 rounded-full">
            <img class="rounded-full w-8/12" src="{{ $user->imagen ? asset('perfiles') . '/' .$user->imagen : asset('img/usuario.svg') }}" alt="Imagen usuario"/>
        </div>
        ...
        <div class="md:w-8/12 lg:w-6/12 px-5 flex flex-col items-center md:justify-center md:items-start py-10 md:py-10">
            ...
            <p class="text-gray-700 text-sm mb-3 font-bold">
                ...
                <span class="font-normal">@choice('Follow|Followers', $user->followers->count())</span>
            </p>
